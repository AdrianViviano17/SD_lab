...
public final class CalculatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.franco.producto.Request,
      com.franco.producto.Response> getSumMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Sum",
      requestType = com.franco.producto.Request.class,
      responseType = com.franco.producto.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.franco.producto.Request,
      com.franco.producto.Response> getSumMethod() {
    io.grpc.MethodDescriptor<com.franco.producto.Request, com.franco.producto.Response> getSumMethod;
      ...
      synchronized (CalculatorGrpc.class) {
        if ((getSumMethod = CalculatorGrpc.getSumMethod) == null) {
          CalculatorGrpc.getSumMethod = getSumMethod =
              io.grpc.MethodDescriptor.<com.franco.producto.Request, com.franco.producto.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Sum"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.franco.producto.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.franco.producto.Response.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sum(com.franco.producto.Request request,
        io.grpc.stub.StreamObserver<com.franco.producto.Response> responseObserver) {
  ...
  public static final class CalculatorStub
    ...
    /**
     */
    public void sum(com.franco.producto.Request request,
        io.grpc.stub.StreamObserver<com.franco.producto.Response> responseObserver) {
  ...
  public static final class CalculatorBlockingStub
    ...
    /**
     */
    public com.franco.producto.Response sum(com.franco.producto.Request request) {
  ...
  public static final class CalculatorFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.franco.producto.Response> sum(
        com.franco.producto.Request request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUM:
          serviceImpl.sum((com.franco.producto.Request) request,
              (io.grpc.stub.StreamObserver<com.franco.producto.Response>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.franco.producto.Request,
              com.franco.producto.Response>(
  ...
  private static abstract class CalculatorBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.franco.producto.CalculatorProto.getDescriptor();
    }
